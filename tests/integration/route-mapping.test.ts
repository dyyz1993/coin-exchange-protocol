...
describe('路由-控制器映射测试', () => {
  ...
  describe('账户相关路由', () => {
    test('GET /api/account/balance/:userId - 获取余额', () => {
      const route = routes.find(r => r.path === '/api/account/balance/:userId' && r.method === 'GET');
    ...
    test('GET /api/account/transactions/:userId - 获取交易历史', () => {
      const route = routes.find(r => r.path === '/api/account/transactions/:userId' && r.method === 'GET');
      expect(route).toBeDefined();
  ...
  describe('空投相关路由', () => {
    ...
    test('POST /api/airdrop/activate/:airdropId - 激活空投', () => {
      const route = routes.find(r => r.path === '/api/airdrop/activate/:airdropId' && r.method === 'POST');
      expect(route).toBeDefined();
    ...
    test('GET /api/airdrop/can-claim/:airdropId/:userId - 检查是否可领取', () => {
      const route = routes.find(r => r.path === '/api/airdrop/can-claim/:airdropId/:userId' && r.method === 'GET');
      expect(route).toBeDefined();
    ...
    test('GET /api/airdrop/claims/:userId - 获取用户领取记录', () => {
      const route = routes.find(r => r.path === '/api/airdrop/claims/:userId' && r.method === 'GET');
      expect(route).toBeDefined();
  ...
  describe('任务相关路由', () => {
    ...
    test('POST /api/task/activate/:taskId - 激活任务', () => {
      const route = routes.find(r => r.path === '/api/task/activate/:taskId' && r.method === 'POST');
      expect(route).toBeDefined();
      expect(route?.description).toContain('激活');
    ...
    test('GET /api/task/can-complete/:taskId/:userId - 检查是否可完成', () => {
      const route = routes.find(r => r.path === '/api/task/can-complete/:taskId/:userId' && r.method === 'GET');
      expect(route).toBeDefined();
      expect(route?.description).toContain('检查');
    ...
    test('GET /api/task/completions/:userId - 获取用户完成记录', () => {
      const route = routes.find(r => r.path === '/api/task/completions/:userId' && r.method === 'GET');
      expect(route).toBeDefined();
    ...
    test('POST /api/task/cancel/:taskId - 取消任务', () => {
      const route = routes.find(r => r.path === '/api/task/cancel/:taskId' && r.method === 'POST');
      expect(route).toBeDefined();
