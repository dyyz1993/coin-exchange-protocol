...
export class AirdropService {
    ...
    async claimAirdrop(airdropId, userId) {
        ...
        // 增加用户代币
        const result = await accountService.addTokens(userId, airdrop.perUserAmount, TransactionType.AIRDROP, `空投奖励: ${airdrop.name}`, claim.id);
        return {
            success: true,
