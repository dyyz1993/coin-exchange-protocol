...
import { BlacklistEntry, BlacklistType, BlacklistStatus, UserDisputeStats } from '../types';

export class BlacklistModel {
  private blacklist: Map<string, BlacklistEntry> = new Map();
  private userDisputeStats: Map<string, UserDisputeStats> = new Map();
   ...
   * 检查是否需要自动拉黑
   */
  checkAutoBlacklist(userId: string): { shouldBlacklist: boolean; reason?: string } {
    const stats = this.getUserDisputeStats(userId);
